...
**Resource Requirements:** Successful implementation will require dedicated resources, cross-functional collaboration, and executive sponsorship.`,
    ...
    const selectedSummary =
      mockSummaries[summaryType as keyof typeof mockSummaries][
        summaryLength as keyof typeof mockSummaries.bullet
      ];
            ...
            <CardContent className="space-y-6">
              {isLoading ? (
                <div className="flex items-center justify-center py-12">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      AI is analyzing and summarizing your text...
                    </p>
                  </div>
                </div>
              ) : summary ? (
                ...
                <div className="py-12 text-center text-muted-foreground">
                  ...
                  <p>
                    Enter text and click &quot;Generate Summary&quot; to get
                    started
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Advanced AI algorithms understand context and extract key
                    information
                  </p>
                </div>
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose from bullet points, paragraphs, or executive
                    summaries
                  </p>
                </div>
                <div className="text-center p-4">
