...
export default function IELTSVocabulary() {
  ...
  const generateQuizOptions = (correctWord: VocabWord) => {
    ...
    const allOptions = [correctWord, ...wrongOptions].sort(
      () => Math.random() - 0.5
    );
          ...
          <Card className="shadow-lg border-0">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-background rounded-lg">
                  <div className="text-2xl font-bold text-foreground">
                    {Math.floor(quizResult.timeSpent / 60)}:
                ...
                <div className="text-center p-4 bg-background rounded-lg">
                  <div className="text-2xl font-bold text-foreground">
                    {quizResult.correctWords.length}/{quizResult.totalQuestions}
                  </div>
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                <CardTitle className="text-2xl text-center">
                  What does &quot;
                  <span className="text-primary">{currentQuizWord.word}</span>
                  &quot; mean?
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <Button onClick={nextQuizQuestion} disabled={!selectedAnswer}>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Choose how you want to learn vocabulary
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Button
                    variant={
                      currentMode === "flashcards" ? "default" : "outline"
                    }
                      ...
                      <div className="flex items-center space-x-1">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`w-4 h-4 ${
                              i < currentWord.ieltsFrequency / 2
          ...
          <div className="space-y-6">
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-4">
                ...
                <Progress
                  value={(masteredWords.size / filteredWords.length) * 100}
                  className="w-full"
                />
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex items-start space-x-2">
                  ...
                  <span>
                    Focus on high-frequency words for better exam performance
                  </span>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-background0 rounded-full mt-2"></div>
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {
                      vocabularyData.filter((w) => w.difficulty === "beginner")
                        .length
                    }
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {
                      vocabularyData.filter((w) => w.difficulty === "advanced")
                        .length
                    }
                  </span>
                </div>
